...
//     nextPlayer(playerOne, playerTwo)
//     currentScoreOne.textContent = currentScore;
//     scoreOne.textContent = `${Number(scoreOne.textContent) + highScore}`;
//     if (Number(scoreOne.textContent) >= 100){
//       playerOne.classList.add("player--winner");
//     }
//   } else if (playerTwo.classList.contains("player--active")){
//     nextPlayer(playerTwo, playerOne)
//     currentScoreTwo.textContent = currentScore;
//     scoreTwo.textContent = `${Number(scoreTwo.textContent) + highScore}`;
//     if (Number(scoreTwo.textContent) >= 100){
...
// function nextPlayer(activePlayer, nextPlayer){
